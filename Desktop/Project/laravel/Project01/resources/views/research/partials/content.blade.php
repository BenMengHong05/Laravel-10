...
<section class="container education-imgae mt-5  position-relative ">
    <div class="row">
        <div class="col-lg-3">
            <figure class="figure ">
                <img src="{{ asset('images/research1.jpg') }}" class="figure-img img-fluid" alt="..."​​>
            </figure>
        </div>
        <div class="col-lg-3">
            <figure class="figure">
                <img src="{{ asset('images/research2.jpg') }}" class="figure-img  img-fluid" alt="..."​>
            </figure>

        </div>
        <div class="col-lg-3">
            <figure class="figure">
                <img src="{{ asset('images/research3.jpeg') }}" class="figure-img  img-fluid" alt="..."​​>
            </figure>

        </div>
        <div class="col-lg-3">
            <figure class="figure">
                <img src="{{ asset('images/research4..jpeg') }}" class="figure-img img-fluid " alt="..."​​>
            </figure>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-4">
            <figure class="figure" >
                <img src="{{ asset('images/research5.jpeg') }}" class="figure-img img-fluid " alt="..."​​>
             </figure>
        </div>
        <div class="col-lg-4">
            <figure class="figure">
                <img src="{{ asset('images/research6.jpeg') }}" class="figure-img img-fluid " alt="..."​​>
            </figure>
            <figure class="figure">
                <img src="{{ asset('images/research7.jpeg') }}" class="figure-img img-fluid " alt="..."​​>
            </figure>

        </div>
        <div class="col-lg-4">
            <figure class="figure">
                <img src="{{ asset('images/research8.jpeg') }}" class="figure-img img-fluid " alt="..."​​>
            </figure>
        </div>
    </div>
</section>
