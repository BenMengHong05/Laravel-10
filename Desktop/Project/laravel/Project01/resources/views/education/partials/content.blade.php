        ...
        <div class="container mt-5">
            <div class="row ">
                <h1>
                    ...
                    departments across five schools and one college, our
                    ...
                    interdisciplinary programs, we offer excellence across the board.
                </h1>
            </div>
        </div>
        <div class="container mt-5">
...
<section class="container education-imgae mt-5  position-relative d-flex justify-content-center">
    <div class="row" style="width: 95%">
        <div class="col-md-6 col-lg-6">
            <div class="row m-2">
                <div class="col-md-12 col-lg-12" style="height: 50vh;">
                    <img src="{{asset('images/imgeducation1.jpg')}}" alt="" width="100%" height="100%">
                </div>
            </div>
            <div class="row m-2 ">
                <div class="col-md-6 col-lg-6"  style="height: 25vh;">
                    <img src="{{asset('images/imgeducation2.jpeg')}}" alt="" width="100%" height="100%">
                </div>
                <div class="col-md-6 col-lg-6"  style="height: 25vh;">
                    <img src="{{asset('images/imgeduaction3.jpg')}}" alt="" width="100%" height="100%">
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="row m-2">
                <div class="col-md-6 col-lg-6" style="height: 25vh;">
                    <img src="{{asset('images/imgeduaction.jpg')}}" alt="" width="100%" height="100%">
                </div>
                <div class="col-md-6 col-lg-6" style="height: 25vh;">
                    <img src="{{asset('images/imgeducation.jpg')}}" alt="" width="100%" height="100%">
                </div>
            </div>
            <div class="row m-2">
                <div class="col-md-12 col-lg-12" style="height: 50vh;">
                    <img src="{{asset('images/imgeducation6.jpg')}}" alt="" width="100%" height="100%">
                </div>
            </div>
        </div>
    </div>
